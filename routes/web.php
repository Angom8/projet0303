...
Route::post('admin/fournisseur/add-piece/', ['uses' => 'FournisseurController@addpiece', 'as' => 'fourni.add.piece'])->middleware('auth');//TODO

Route::post('admin/fournisseur/add-equip/', ['uses' => 'FournisseurController@addequip', 'as' => 'fourni.add.equip'])->middleware('auth');//TODO

Route::post('admin/fournisseur/add-adresse/', ['uses' => 'FournisseurController@addadresse', 'as' => 'fourni.add.equip'])->middleware('auth');//TODO
...
Route::get('admin/update-boat/owner/{id}',  ['uses' =>'BateauController@owner', 'as'=>'boat.admin.owner'])->middleware('is_admin');//TODO

Route::post('admin/update-boat/owner/add',  ['uses' =>'BateauController@owner_add', 'as'=>'boat.admin.owner.add'])->middleware('is_admin');//TODO

Route::post('admin/update-boat/owner/remove',  ['uses' =>'BateauController@owner_remove', 'as'=>'boat.admin.owner.remove'])->middleware('is_admin');//TODO
...
Route::get('panel/fournisseur/{id}', ['uses' => 'FournisseurController@show', 'as' => 'fourni.show'])->middleware('auth');//TODO
